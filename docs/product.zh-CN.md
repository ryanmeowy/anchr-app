...
[![Deployment](https://img.shields.io/badge/Deployment-Self--hosted-2f855a?style=flat-square)](./technical.zh-CN.md)
[![License](https://img.shields.io/badge/License-MIT-bbff66?style=flat-square)](../LICENSE)

[English product overview](../README.md) · 中文产品介绍 · [中文技术文档](./technical.zh-CN.md) · [English technical guide](./technical.en.md)

</div>

<div align="center">
  <a href="./images/overview.png">
    <img src="./images/overview.png" alt="Anchr 产品总览" width="920">
  </a>
  <br>
...
1. 按[中文技术文档](./technical.zh-CN.md)启动 Anchr App，并准备 Anchr Web 与 Anchr Docling；
2. 在设置中完成存储、生成、向量化和排序能力配置；
3. 启动 Web 工作台，按上面的在线体验路径验证完整知识闭环。

当前版本采用**单实例、单租户**部署模型：一套 Anchr App 部署只服务一个组织或团队，并且只运行一个 App 进程（或容器副本）。如果需要服务多个彼此隔离的组织，应为每个组织分别部署完整环境。详见[部署与租户模型](#部署与租户模型)和[中文技术文档](./technical.zh-CN.md#单实例单租户架构约束)。
...
<div align="center">
  <a href="./images/citation-preview.png">
    <img src="./images/citation-preview.png" alt="Anchr 引用与原文核验" width="780">
  </a>
  <br>
...
<div align="center">
  <a href="./images/agent-activity.png">
    <img src="./images/agent-activity.png" alt="Anchr Agent 文档任务" width="780">
  </a>
  <br>
...
- [中文技术文档](./technical.zh-CN.md)：安装、配置、接口、开发和生产注意事项；
- [English technical guide](./technical.en.md)：英文技术说明；
- [Agent RAG 当前实现](./agent-rag-workflow.md)：Agent、证据、降级与恢复行为；
- [领域边界与交互](./domain-boundaries-and-interactions.md)：系统职责与状态边界；
